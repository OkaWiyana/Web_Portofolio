  ...
  return (
    <div className="footer bg-white shadow mt-20" id="footer">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between text-center md:text-left">
        <p className="py-4">
          &copy; Copyright by:{" "}
          <span className="font-bold">I Gusti Lanang Oka Wiyana</span>{" "}
        </p>
        <div className="flex items-center">
          ...
          <a
            ...
            target="_blank"
            className="w-8 h-8 mr-3 rounded-full flex justify-center items-center border border-slate-500 text-slate-500 hover:border-blue-600 hover:bg-blue-600 hover:text-white"
          >
            <svg
              role="img"
              width={18}
